...
// MeParams contains all the bound params for the me operation
...
func (o *MeParams) bindAccessToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
		return errors.Required("access_token", "query")
	}
	var raw string
	if len(rawData) > 0 {
